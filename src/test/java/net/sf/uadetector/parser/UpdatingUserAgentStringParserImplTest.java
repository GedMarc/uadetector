...
public class UpdatingUserAgentStringParserImplTest
{
	...
	private static final java.util.logging.Logger LOG = java.util.logging.Logger.getLogger(UpdatingUserAgentStringParserImplTest.class.toString());
	...
	{
		assertThat("20120509-01".equals(PARSER.getDataStore()
		                                      .getData()
		                                      .getVersion())).isFalse();
	...
	{
		String userAgent = "Mozilla/5.0 (Linux; Android 4.4.2; sv-se; SAMSUNG GT-I9505 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Version/1.5 Chrome/28.0.1500.94 Mobile Safari/537.36";
	...
	{
		UpdatingUserAgentStringParserImpl parser = new UpdatingUserAgentStringParserImpl(new TestXmlDataStore());
		parser.getDataStore()
		      .refresh();
	}
	...
	{
		UpdatingUserAgentStringParserImpl parser = new UpdatingUserAgentStringParserImpl(new TestXmlDataStore());
		long firstLastUpdateCheck = parser.getDataStore()
		                                  .getUpdateOperation()
		                                  .getLastUpdateCheck();
		...
		Thread.sleep(1000l);
		long currentLastUpdateCheck = parser.getDataStore()
		                                    .getUpdateOperation()
		                                    .getLastUpdateCheck();
	...
	public void testWrongUrl() throws Exception
	{
		...
		UpdatingUserAgentStringParserImpl parser = new UpdatingUserAgentStringParserImpl(new NotUpdateableXmlDataStore());
		LOG.finer("Reducing the update interval during the test.");
