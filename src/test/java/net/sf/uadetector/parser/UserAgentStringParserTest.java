...
public class UserAgentStringParserTest
{
	...
	{
		assertThat(PARSER.getDataStore()
		                 .getData()
		                 .getVersion()).isEqualTo(TestXmlDataStore.VERSION_NEWER);
	...
	{
		String userAgent = "http://Anonymouse.org/ (Unix)";
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEmpty();
		...
		DeviceCategory category = agent.getDeviceCategory();
	...
	{
		String userAgent = "Mozilla/5.0 (BB10; Touch) AppleWebKit/537.10+ (KHTML, like Gecko) Version/10.1.0.4633 Mobile Safari/537.10+";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
	...
	{
		String userAgent = "BlackBerry 9000: BlackBerry9000/4.6.0.65 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/102";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
	...
	{
		String userAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_6_8) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/13.0.782.112 Safari/535.1";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("13.0.782.112");
	...
	{
		String userAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_6_8) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/$ Safari/535.1";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
	...
	public void parse_browser_CHROME13() throws Exception
	{
		...
		assertThat(os.getProducerUrl()).isEqualTo("http://www.apple.com/");
		assertThat(os.getUrl()).isEqualTo("http://www.apple.com/osx/");
		assertThat(os.getVersionNumber()
		             .toVersionString()).isEqualTo("10.6.8");
	...
	{
		String userAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_4) AppleWebKit/536.5 (KHTML, like Gecko) Chrome/19.0.1084.46 Safari/536.5";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getUrl()).isEqualTo("http://www.google.com/chrome");
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("19.0.1084.46");
		...
		assertThat(os.getUrl()).isEqualTo("http://www.apple.com/osx/");
		assertThat(os.getVersionNumber()
		             .toVersionString()).isEqualTo("10.7.4");
	...
	{
		String userAgent = "Eudora/6.2.4b8 (MacOS)";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getUrl()).isEqualTo("http://www.eudora.com/archive.html");
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("6.2.4b8");
	...
	{
		String userAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:6.0) Gecko/20100101 Firefox/6.0";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(os.getUrl()).isEqualTo("http://www.apple.com/osx/");
		assertThat(os.getVersionNumber()
		             .toVersionString()).isEqualTo("10.7");
	...
	{
		String userAgent = "Mozilla/5.0 (X11; U; Linux i686; de; rv:1.9.1.5) Gecko/20091112 Iceweasel/3.5.5 (like Firefox/3.5.5; Debian-3.5.5-1)";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("3.5.5");
	...
	{
		String userAgent = "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; WOW64; Trident/4.0; GTB6.4; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; OfficeLiveConnector.1.3; OfficeLivePatch.0.0; .NET CLR 1.1.4322)";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
	...
	{
		String userAgent = "Java/1.6.0_31";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("1.6.0_31");
	...
	{
		String userAgent = "Klondike/1.50 (HTTP Win32)";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("1.50");
	...
	public void parse_browser_mobile_CHROME() throws Exception
	{
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("16.0.912.75");
		...
		assertThat(os.getVersionNumber()
		             .toVersionString()).isEqualTo("4.0.3");
	...
	{
		String userAgent = "Mozilla/5.0 (iPad; U; CPU OS 4_2_1 like Mac OS X; ja-jp) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8C148 Safari/6533.18.5";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getUrl()).isEqualTo("http://en.wikipedia.org/wiki/Safari_%28web_browser%29");
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("5.0.2");
		...
		assertThat(os.getVersionNumber()
		             .toVersionString()).isEqualTo("4.2.1");
	...
	{
		String userAgent = "Opera/9.80 (Windows NT 5.1; U; cs) Presto/2.2.15 Version/10.00";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
	...
	public void parse_browser_SAFARI() throws Exception
	{
		...
		assertThat(agent.getUrl()).isEqualTo("http://en.wikipedia.org/wiki/Safari_%28web_browser%29");
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("5.1.5");
	...
	{
		String userAgent = "Mozilla/5.0 (Linux; U; Android 2.3.4; en-us; Silk/1.1.0-80) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1 Silk-Accelerated=true";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("1.1.0-80");
	...
	{
		String userAgent = "SiteSucker/1.6.9";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("1.6.9");
	...
	{
		String userAgent = "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_7; en-us) AppleWebKit/530.17 (KHTML, like Gecko) Version/4.0 Safari/530.17 Skyfire/2.0";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
	...
	{
		String userAgent = "Mozilla/5.0 AppleWebKit/530.17 (KHTML, like Gecko) Version/4.0 Safari/530.17 Skyfire/2.0";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
	...
	{
		UserAgent agent = PARSER.parse("");

		// check user agent informations
		UserAgent e = UserAgent.EMPTY;
	...
	public void parse_robot_SETOOZ() throws Exception
	{
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("0.20 b");
	...
	{
		String userAgent = "JoeDog/1.00 [en] (X11; I; Siege 2.68)";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("2.68");
	...
	{
		UserAgent agent = PARSER.parse("qwertzuiopasdfghjklyxcvbnm");
	...
	{
		String userAgent = "W3C_Validator/1.654";
		UserAgent agent = PARSER.parse(userAgent);
		assertThat(agent).isNotNull();
		...
		assertThat(agent.getVersionNumber()
		                .toVersionString()).isEqualTo("1.654");
