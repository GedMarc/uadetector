...
public class BrowserOperatingSystemMappingBuilderTest
{
	...
	{
		Builder b = new BrowserOperatingSystemMapping.Builder().setBrowserId("12345");
	...
	{
		Builder b = new BrowserOperatingSystemMapping.Builder().setOperatingSystemId("12345");
	...
	public void testGetters()
	{
		...
		BrowserOperatingSystemMapping m = builder.build();
