...
public class BrowserPatternTest
{
	...
	public void compare_differentPatternFlags()
	{
		...
		BrowserPattern pattern2 = new BrowserPattern(1, Pattern.compile("[0-9]+", Pattern.CASE_INSENSITIVE), 1);
	...
	{
		BrowserPattern pattern1 = new BrowserPattern(1, Pattern.compile("[0-9]+", Pattern.MULTILINE | Pattern.CASE_INSENSITIVE), 1);
		BrowserPattern pattern2 = new BrowserPattern(1, Pattern.compile("[0-9]+", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE), 1);
	...
	public void compareTo_differentPosition()
	{
		...
		BrowserPattern pattern2 = new BrowserPattern(1, Pattern.compile("[0-9]+"), 2);
		assertThat(pattern1.compareTo(pattern2)).isEqualTo(-1);
		assertThat(pattern2.compareTo(pattern1)).isEqualTo(1);
	}
	...
	{
		BrowserPattern pattern1 = new BrowserPattern(1, Pattern.compile("[0-9]+", Pattern.CASE_INSENSITIVE), 1);
		BrowserPattern pattern2 = new BrowserPattern(1, Pattern.compile("[0-9]+", Pattern.MULTILINE), 1);
		assertThat(pattern1.equals(pattern2)).isFalse();
	...
	{
		BrowserPattern pattern1 = new BrowserPattern(1, Pattern.compile("[0-9]+"), 1);
		BrowserPattern pattern2 = new BrowserPattern(1, Pattern.compile("[a-z]+"), 1);
		assertThat(pattern1.equals(pattern2)).isFalse();
		assertThat(pattern1.hashCode() == pattern2.hashCode()).isFalse();
	...
	{
		BrowserPattern pattern = new BrowserPattern(1, Pattern.compile("[0-9]+"), 1);
		OperatingSystemPattern otherClass = new OperatingSystemPattern(1, Pattern.compile("[0-9]+"), 2);
	...
	public void testGetters()
	{
		...
		BrowserPattern pattern = new BrowserPattern(12345, p, 98765);
