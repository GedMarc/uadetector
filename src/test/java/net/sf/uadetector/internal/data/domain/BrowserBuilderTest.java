...
public class BrowserBuilderTest
{
	...
	{
		BrowserType browserType = new BrowserType.Builder().setId("1")
		                                                   .setName("browser type test")
		                                                   .build();
		...
		SortedSet<BrowserPattern> patternSet = new TreeSet<>();

		Browser.Builder original = new Browser.Builder();
		...
		Builder copy1 = new Browser.Builder(original);
		...
		assertThat(copy1.getType()
		                .getName()).isEqualTo("browser type test");
		assertThat(copy1.getType()
		                .getId()).isEqualTo(1);
		assertThat(copy1.getTypeId()).isEqualTo(1);
		assertThat(copy1.getUrl()).isEqualTo("u1");

		Builder copy2 = original.copy();
	...
	{
		BrowserType type = new BrowserType.Builder().setId("13746")
		                                            .setName("browser type test")
		                                            .build();
	...
	public void testGetters() throws Exception
	{
		...
		assertThat(browser.getType()
		                  .getName()).isEqualTo("browser type test");
		assertThat(browser.getType()
		                  .getId()).isEqualTo(1);
		assertThat(browser.getUrl()).isEqualTo("u1");

		Browser browserRebuild = new Builder(builder.build()).build();
		...
		assertThat(browserRebuild.getType()
		                         .getName()).isEqualTo("browser type test");
		assertThat(browserRebuild.getType()
		                         .getId()).isEqualTo(1);
