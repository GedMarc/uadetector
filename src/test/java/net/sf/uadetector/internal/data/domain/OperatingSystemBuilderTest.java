...
public class OperatingSystemBuilderTest
{
	...
	{
		Set<OperatingSystemPattern> patterns = new HashSet<>();
		...
		OperatingSystem.Builder original = new OperatingSystem.Builder();
		...
		OperatingSystem.Builder copy1 = new OperatingSystem.Builder(original);
		...
		OperatingSystem.Builder copy2 = original.copy();
		...
		OperatingSystem.Builder copy3 = new OperatingSystem.Builder(original.build());
	...
	{
		OperatingSystem b1 = new OperatingSystem.Builder().setId("1")
		                                                  .setFamily("f1")
		                                                  .setIcon("i1")
		                                                  .setInfoUrl("iu1")
		                                                  .setProducer("p1")
		                                                  ...
		                                                  .setUrl("u1")
		                                                  .build();
		OperatingSystem b2 = new OperatingSystem.Builder().setId(1)
		                                                  .setFamily("f1")
		                                                  .setIcon("i1")
		                                                  .setInfoUrl("iu1")
		                                                  .setProducer("p1")
	...
	public void setPatterns_successful()
	{
		...
		OperatingSystem.Builder builder = new OperatingSystem.Builder().setPatterns(patterns);
	...
	public void testGetters() throws Exception
	{
		...
		OperatingSystem os = builder.build();
