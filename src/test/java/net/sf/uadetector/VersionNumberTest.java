...
public class VersionNumberTest
{
	...
	{
		VersionNumber version1 = new VersionNumber(Arrays.asList("0", "0", "1"));
		VersionNumber version2 = new VersionNumber(Arrays.asList("0", "0", "2"));
	...
	{
		VersionNumber version1 = new VersionNumber("1", "12", "1", "pre");
		VersionNumber version2 = new VersionNumber("1", "12", "1", "");
		assertThat(version1.compareTo(version2) > 0).isTrue();
		assertThat(version2.compareTo(version1) < 0).isTrue();

		VersionNumber version3 = new VersionNumber("1", "12", "1", "a");
		VersionNumber version4 = new VersionNumber("1", "12", "1", "b");
		assertThat(version3.compareTo(version4) < 0).isTrue();
		assertThat(version4.compareTo(version3) > 0).isTrue();

		VersionNumber version5 = new VersionNumber(Arrays.asList("1", "12", "1", "0"));
		VersionNumber version6 = new VersionNumber("1", "12", "1", "b");
		assertThat(version5.compareTo(version6) > 0).isTrue();
		assertThat(version6.compareTo(version5) < 0).isTrue();

		VersionNumber version7 = new VersionNumber(Arrays.asList("1", "12", "1", "0"), "a");
		VersionNumber version8 = new VersionNumber("1", "12", "1", "b");
	...
	{
		VersionNumber version1 = new VersionNumber(Arrays.asList("1", "0", "1"));
		VersionNumber version2 = new VersionNumber(Arrays.asList("0", "0", "2"));
		assertThat(version1.compareTo(version2)).isEqualTo(1);
		assertThat(version2.compareTo(version1)).isEqualTo(-1);
	}
	...
	{
		VersionNumber version1 = new VersionNumber(Arrays.asList("1", "102", "1"));
		VersionNumber version2 = new VersionNumber(Arrays.asList("1", "12", "1"));
		assertThat(version1.compareTo(version2)).isEqualTo(1);
		assertThat(version2.compareTo(version1)).isEqualTo(-1);
	}
	...
	{
		VersionNumber version1 = new VersionNumber(Arrays.asList("11", "0", "0", "1"));
		VersionNumber version2 = new VersionNumber(Arrays.asList("11", "0", "0"));
		assertThat(version1.compareTo(version2)).isEqualTo(1);
		assertThat(version2.compareTo(version1)).isEqualTo(-1);
	}
	...
	{
		List<VersionNumber> src = new ArrayList<>();
		...
		List<VersionNumber> scrambled = Arrays.asList(new VersionNumber[src.size()]);
	...
	{
		List<VersionNumber> src = new ArrayList<>(18);
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("0", "0", "0"));
	...
	{
		VersionNumber version1 = new VersionNumber(Arrays.asList("1", "0", "1"));
		ReadableVersionNumber mockVersion = EasyMock.createStrictMock(ReadableVersionNumber.class);
		EasyMock.expect(mockVersion.getGroups())
		        .andReturn(null);
	...
	{
		ReadableVersionNumber otherImpl = EasyMock.createMock(ReadableVersionNumber.class);
		EasyMock.expect(otherImpl.getGroups())
		        .andReturn(null)
		        .anyTimes();
		EasyMock.replay(otherImpl);
		VersionNumber version = new VersionNumber(Arrays.asList("1", "0", "0"));
	...
	{
		VersionNumber version = new VersionNumber("0");
	...
	{
		VersionNumber v = new VersionNumber(Arrays.asList(null, null, null, "0"));
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("4"));
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("18", "0", "1025", "162"));
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("1", VersionNumber.EMPTY_GROUP, VersionNumber.EMPTY_GROUP));
	...
	{
		VersionNumber v = new VersionNumber(Arrays.asList(VersionNumber.EMPTY_GROUP, VersionNumber.EMPTY_GROUP,
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("0", VersionNumber.EMPTY_GROUP, "0"));
		assertThat(version.getMajor()).isEqualTo("0");
		assertThat(version.getMinor()).isEqualTo(VersionNumber.EMPTY_GROUP);
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("0", "0", "0", "001"));
		assertThat(version.getMajor()).isEqualTo("0");
		assertThat(version.getMinor()).isEqualTo("0");
		assertThat(version.getBugfix()).isEqualTo("0");
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("1", "2"));
		assertThat(version.getMajor()).isEqualTo("1");
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("1", "2", "0"));
		assertThat(version.getMajor()).isEqualTo("1");
		assertThat(version.getMinor()).isEqualTo("2");
		assertThat(version.getBugfix()).isEqualTo("0");
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("1", "2", "0", null));
		assertThat(version.getMajor()).isEqualTo("1");
		assertThat(version.getMinor()).isEqualTo("2");
		assertThat(version.getBugfix()).isEqualTo("0");
		assertThat(version.toVersionString()).isEqualTo("1.2.0");
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("1", "2", VersionNumber.EMPTY_GROUP));
		assertThat(version.getMajor()).isEqualTo("1");
		assertThat(version.getMinor()).isEqualTo("2");
		assertThat(version.getBugfix()).isEqualTo(VersionNumber.EMPTY_GROUP);
		assertThat(version.toVersionString()).isEqualTo("1.2");
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("1", "2", null));
		assertThat(version.getMajor()).isEqualTo("1");
		assertThat(version.getMinor()).isEqualTo("2");
		assertThat(version.getBugfix()).isEqualTo(VersionNumber.EMPTY_GROUP);
		assertThat(version.toVersionString()).isEqualTo("1.2");
	...
	{
		VersionNumber version = new VersionNumber(Arrays.asList("1", null, "1"));
		assertThat(version.getMajor()).isEqualTo("1");
		assertThat(version.getMinor()).isEqualTo(VersionNumber.EMPTY_GROUP);
	...
	{
		VersionNumber version1 = new VersionNumber("1", "0", "0", "-beta5");
		VersionNumber version2 = new VersionNumber("1", "0", "0", "-stable");
		assertThat(version1.equals(version2)).isFalse();
		assertThat(version2.equals(version1)).isFalse();
		assertThat(version1.hashCode() == version2.hashCode()).isFalse();
	}
	...
	{
		VersionNumber version1 = new VersionNumber(Arrays.asList("0", "0", "0"));
		VersionNumber version2 = new VersionNumber(Arrays.asList("1", "0", "0"));
		assertThat(version1.equals(version2)).isFalse();
		assertThat(version2.equals(version1)).isFalse();
		assertThat(version1.hashCode() == version2.hashCode()).isFalse();
	}
	...
	{
		VersionNumber version1 = new VersionNumber(Arrays.asList("0", "0", "0"));
		VersionNumber version2 = new VersionNumber(Arrays.asList("0", "12", "0"));
		assertThat(version1.equals(version2)).isFalse();
		assertThat(version2.equals(version1)).isFalse();
		assertThat(version1.hashCode() == version2.hashCode()).isFalse();
	}
	...
	{
		VersionNumber version1 = new VersionNumber(Arrays.asList("0", "0", "0"));
		VersionNumber version2 = new VersionNumber(Arrays.asList("0", "0", "0", "1"));
		assertThat(version1.equals(version2)).isFalse();
		assertThat(version2.equals(version1)).isFalse();
		assertThat(version1.hashCode() == version2.hashCode()).isFalse();
	}
	...
	{
		VersionNumber version1 = new VersionNumber("18", "0", "1025", "-stable");
		VersionNumber version2 = new VersionNumber("18", "0", "1025", "-stable");
	...
	{
		new VersionNumber(Arrays.asList("1", "2", "0")).getGroups()
		                                               .add("1");
	}
	...
	{
		List<String> groups1 = VersionNumber.replaceNullValueWithEmptyGroup(Arrays.asList("1"));
		...
		List<String> groups2 = VersionNumber.replaceNullValueWithEmptyGroup(Arrays.asList("1", "2"));
		...
		List<String> groups3 = VersionNumber.replaceNullValueWithEmptyGroup(Arrays.asList("1", null));
	...
	{
		List<String> groups = VersionNumber.replaceNullValueWithEmptyGroup(Arrays.asList(null, null, "1"));
	...
	{
		List<String> groups = VersionNumber.replaceNullValueWithEmptyGroup(Arrays.asList("-1", VersionNumber.EMPTY_GROUP, "1"));
		assertThat(groups).hasSize(3);
	...
	public void testToString()
	{
		...
		VersionNumber version = new VersionNumber("1", "2", "0", "-stable");
